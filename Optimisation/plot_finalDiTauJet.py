...
if __name__ == '__main__':
    ...
    df = pd.read_pickle("/afs/cern.ch/work/j/jleonhol/private/TauTriggerDev/results_ditaujet.pickle")   
    ...
    plot("rate", "eff", df["params"], "Rate (Hz)", "Efficiency", 0., 100., 0., 1., "plot_tri_pt_optimised_cut.pdf", data=df)
