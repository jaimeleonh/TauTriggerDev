...
def run_optimization(dataset_rate, dataset_eff, rate_budget = 18):
    def f(a):
        a = np.append(a, [0])
    ...
    res = minimize(f, [0.55, 0.45], bounds=((0.05, 0.6), (0.05, 0.6)), method="L-BFGS-B", options={"eps": [0.01, 0.01]})
...
if __name__ == '__main__':
    ...
    N_den, N_num = dataset_rate.get_Nnum_Nden_DiTauJetPNet(optim_x)
