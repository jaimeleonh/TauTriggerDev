...
if __name__ == '__main__':
    ...
    # plot("rate", "eff", df["params"], "Rate (Hz)", "Efficiency", 0, 100, 0., 1., "plot_optimised_ditau.pdf", data=df, params_to_mark=[["deeptau"], [0.56, 0.47]])
    plot("rate", "eff", df["params"], "Rate (Hz)", "Efficiency", 55, 57, 0.7975, 0.81, "plot_optimised_ditau_cut.pdf", data=df, params_to_mark=[["deeptau"], [0.56, 0.47]], plot_text=True)
